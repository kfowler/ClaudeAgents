...
description: "Use this agent for full-stack web application development with modern frameworks (React/Next.js 15+, Svelte/SvelteKit, Remix, Vue/Nuxt) and backends (Node.js, Python/FastAPI, Bun, Go, Rust). Handles technology stack selection, architecture setup, client/server implementation, database integration, edge computing, and real-time systems. For complex multi-domain projects, use project-orchestrator instead."
color: blue
model: sonnet
